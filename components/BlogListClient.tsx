      ...
      <div className="mb-12 flex flex-col gap-6 sm:flex-row sm:items-center sm:justify-between">
        <div className="relative flex-grow">
          <input
            ...
            className="w-full rounded-md border border-zinc-200 bg-white/80 px-4 py-2.5 pr-10 text-zinc-900 shadow-sm backdrop-blur-md focus:border-zinc-400 focus:ring-1 focus:ring-zinc-400 focus:outline-none dark:border-zinc-700 dark:bg-zinc-900/80 dark:text-zinc-100 dark:backdrop-blur-md dark:focus:border-zinc-500 dark:focus:ring-zinc-500"
          />
          <svg
        ...
        <div className="relative min-w-[200px]">
          <select
            ...
            className="w-full appearance-none rounded-md border border-zinc-200 bg-white/80 px-4 py-2.5 pr-8 text-zinc-900 shadow-sm backdrop-blur-md focus:border-zinc-400 focus:ring-1 focus:ring-zinc-400 focus:outline-none dark:border-zinc-700 dark:bg-zinc-900/80 dark:text-zinc-100 dark:backdrop-blur-md dark:focus:border-zinc-500 dark:focus:ring-zinc-500"
          >
